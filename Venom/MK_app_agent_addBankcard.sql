...
-- 渠道
-- // 根据手机号查询银行卡记录
SELECT COUNT(t.id) FROM cls_market_etc.cls_market_etc_agent_bank_card t WHERE t.phone_num = '13060047683';
...
-- 查最后一条记录
SELECT COUNT(t.id) FROM chelaishun.t_sms_union_log t WHERE /*t.mobile = '15639839637' AND*/ t.sms_channel = 3;
